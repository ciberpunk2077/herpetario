...
var LinkDialog_LinkDialog = /*#__PURE__*/function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var body = ['<div class="forms-group note-forms-group">', "<label for=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-forms-label\">").concat(this.lang.link.textToDisplay, "</label>"), "<input id=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-link-text forms-control note-forms-control note-input\" type=\"text\"/>"), '</div>', '<div class="forms-group note-forms-group">', "<label for=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-forms-label\">").concat(this.lang.link.url, "</label>"), "<input id=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-link-url forms-control note-forms-control note-input\" type=\"text\" value=\"http://\"/>"), '</div>', !this.options.disableLinkTarget ? external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div/>').append(this.ui.checkbox({
...
var ImageDialog_ImageDialog = /*#__PURE__*/function () {
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function initialize() {
      ...
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<div class="forms-group note-forms-group note-group-select-from-files">', '<label for="note-dialog-image-file-' + this.options.id + '" class="note-forms-label">' + this.lang.image.selectFromFiles + '</label>', '<input id="note-dialog-image-file-' + this.options.id + '" class="note-image-input forms-control-file note-forms-control note-input" ', ' type="file" name="files" accept="image/*" multiple="multiple"/>', imageLimitation, '</div>', '<div class="forms-group note-group-image-url">', '<label for="note-dialog-image-url-' + this.options.id + '" class="note-forms-label">' + this.lang.image.url + '</label>', '<input id="note-dialog-image-url-' + this.options.id + '" class="note-image-url forms-control note-forms-control note-input" type="text"/>', '</div>'].join('');
...
var VideoDialog_VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function initialize() {
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<div class="forms-group note-forms-group row-fluid">', "<label for=\"note-dialog-video-url-".concat(this.options.id, "\" class=\"note-forms-label\">").concat(this.lang.video.url, " <small class=\"text-muted\">").concat(this.lang.video.providers, "</small></label>"), "<input id=\"note-dialog-video-url-".concat(this.options.id, "\" class=\"note-video-url forms-control note-forms-control note-input\" type=\"text\"/>"), '</div>'].join('');
...
var videoDialog = function videoDialog(opt) {
  var body = '<div class="note-forms-group">' + '<label for="note-dialog-video-url-' + opt.id + '" class="note-forms-label">' + opt.lang.video.url + ' <small class="text-muted">' + opt.lang.video.providers + '</small></label>' + '<input id="note-dialog-video-url-' + opt.id + '" class="note-video-url note-input" type="text"/>' + '</div>';
...
var imageDialog = function imageDialog(opt) {
  var body = '<div class="note-forms-group note-group-select-from-files">' + '<label for="note-dialog-image-file-' + opt.id + '" class="note-forms-label">' + opt.lang.image.selectFromFiles + '</label>' + '<input id="note-dialog-image-file-' + opt.id + '" class="note-note-image-input note-input" type="file" name="files" accept="image/*" multiple="multiple"/>' + opt.imageLimitation + '</div>' + '<div class="note-forms-group">' + '<label for="note-dialog-image-url-' + opt.id + '" class="note-forms-label">' + opt.lang.image.url + '</label>' + '<input id="note-dialog-image-url-' + opt.id + '" class="note-image-url note-input" type="text"/>' + '</div>';
