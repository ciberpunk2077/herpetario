            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal fade bs-example-modal-lg'>" +
                ...
                "<div class='modal-body'>" +
				  ...
				  "<input value='http://' class='bootstrap-wysihtml5-insert-link-url forms-control' type='text'>" +
                "</div>" +
				"</div>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal fade bs-example-modal-lg'>" +
                ...
                "<div class='modal-body'>" +
                 "<div class='forms-group'>" +
				  "<input value='http://' class='bootstrap-wysihtml5-insert-image-url  m-wrap large forms-control' type='text'>" +
                "</div>" +
				"</div>" +
                "<div class='modal-footer'>" +
