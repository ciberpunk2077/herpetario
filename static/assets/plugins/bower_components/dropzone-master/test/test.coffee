...
describe "Dropzone", ->
  ...
  describe "static functions", ->
    ...
    describe "Dropzone.optionsForElement()", ->
      ...
      it "should return undefined and not throw if it's a forms with an input element of the name 'id'", ->
  ...
  describe "file handling", ->
    ...
    describe "uploadFiles()", ->
      ...
      it "should include hidden files in the forms and unchecked checkboxes and radiobuttons should be excluded", (done) ->
