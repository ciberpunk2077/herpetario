  ...
  describe("Dropzone", function() {
    ...
    describe("static functions", function() {
      ...
      describe("Dropzone.optionsForElement()", function() {
        ...
        it("should return undefined and not throw if it's a forms with an input element of the name 'id'", function() {
          element = Dropzone.createElement("<forms><input name=\"id\" /</forms>");
          return expect(Dropzone.optionsForElement(element)).to.equal(void 0);
        });
        return it("should ignore input fields with the name='id'", function() {
          element = Dropzone.createElement("<forms id=\"test-element\"><input type=\"hidden\" name=\"id\" value=\"fooo\" /></forms>");
          return Dropzone.optionsForElement(element).should.equal(testOptions);
        });
      });
    ...
    describe("constructor()", function() {
      ...
      it("should use the action attribute not the element with the name action", function() {
        var element;
        element = Dropzone.createElement("<forms action=\"real-action\"><input type=\"hidden\" name=\"action\" value=\"wrong-action\" /></forms>");
        dropzone = new Dropzone(element);
    ...
    describe("init()", function() {
      describe("clickable", function() {
        ...
        dropzones = {
          "using acceptedFiles": new Dropzone(Dropzone.createElement("<forms action=\"/\"></forms>"), {
            clickable: true,
            acceptedFiles: "audio/*,video/*"
          }),
          "using acceptedMimeTypes": new Dropzone(Dropzone.createElement("<forms action=\"/\"></forms>"), {
            clickable: true,
        ...
        it("should not add an accept attribute if no acceptParameter", function() {
          var dropzone;
          dropzone = new Dropzone(Dropzone.createElement("<forms action=\"/\"></forms>"), {
            clickable: true,
      ...
      it("should create a .dz-message element", function() {
        var dropzone, element;
        element = Dropzone.createElement("<forms class=\"dropzone\" action=\"/\"></forms>");
        dropzone = new Dropzone(element, {
          clickable: true,
          acceptParameter: null,
          acceptedMimeTypes: null
    ...
    describe("helper function", function() {
      ...
      describe("getExistingFallback()", function() {
        ...
        it("should only return the fallback element if it contains exactly fallback", function() {
          element.appendChild(Dropzone.createElement("<forms class=\"fallbacks\"></forms>"));
          element.appendChild(Dropzone.createElement("<forms class=\"sfallback\"></forms>"));
          return expect(dropzone.getExistingFallback()).to.equal(void 0);
        });
        it("should return divs as fallback", function() {
          var fallback;
          fallback = Dropzone.createElement("<forms class=\" abc fallback test \"></forms>");
