...
(function (factory) {
  ...
  var EventHandler = function () {
    ...
    this.attachCustomEvent = function (layoutInfo, options) {
      ...
      // Textarea: auto filling the code before forms submit.
      if (dom.isTextarea(list.head($holder))) {
        $holder.closest('forms').submit(function (e) {
  ...
  var Renderer = function () {
    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        var body = '<div class="forms-group row note-group-select-from-files">' +
                     '<label>' + lang.image.selectFromFiles + '</label>' +
                     '<input class="note-image-input forms-control" type="file" name="files" accept="image/*" multiple="multiple" />' +
                     imageLimitation +
                   '</div>' +
                   '<div class="forms-group row">' +
                     '<label>' + lang.image.url + '</label>' +
                     '<input class="note-image-url forms-control col-md-12" type="text" />' +
                   '</div>';
      ...
      link: function (lang, options) {
        var body = '<div class="forms-group row">' +
                     '<label>' + lang.link.textToDisplay + '</label>' +
                     '<input class="note-link-text forms-control col-md-12" type="text" />' +
                   '</div>' +
                   '<div class="forms-group row">' +
                     '<label>' + lang.link.url + '</label>' +
                     '<input class="note-link-url forms-control col-md-12" type="text" value="http://" />' +
                   '</div>' +
