...
(function (window, document, Chartist) {
   ...
   *
   * @memberof Chartist.Core
   * @param {Array} pathCoordinates List of point coordinates to be split in the forms [x1, y1, x2, y2 ... xn, yn]
   * @param {Array} values List of associated point values in the forms [v1, v2 .. vn]
   * @param {Object} options Options set by user
