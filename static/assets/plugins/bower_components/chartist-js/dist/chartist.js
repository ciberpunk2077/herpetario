  ...
  function createChart(options) {
    ...
    data.raw.series.forEach(function(series, seriesIndex) {
      ...
      if(seriesOptions.showArea && axisY.range) {
        ...
        // In order to forms the area we'll first split the path by move commands so we can chunk it up into segments
...
(function(window, document, Chartist){
  ...
  var defaultOptions = {
    ...
    // If set to 'accumulate' this property will forms a total for each series point. This will also influence the y-axis and the overall bounds of the chart. In stacked mode the seriesBarDistance property will have no effect.
