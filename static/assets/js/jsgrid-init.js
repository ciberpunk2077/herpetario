! function(document, window, $) {
    ...
    $(document).ready(function($) {
            ...
            _createTextBox: function() {
                return $("<input>").attr("type", "text").attr("class", "forms-control input-sm")
            }
        }), jsGrid.setDefaults("number", {
            _createTextBox: function() {
                return $("<input>").attr("type", "number").attr("class", "forms-control input-sm")
            }
        }), jsGrid.setDefaults("textarea", {
            _createTextBox: function() {
                return $("<input>").attr("type", "textarea").attr("class", "forms-control")
            }
            ...
            _createSelect: function() {
                var $result = $("<select>").attr("class", "forms-control input-sm"),
