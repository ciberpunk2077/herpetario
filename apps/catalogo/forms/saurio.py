...
class SauriosForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['nombre_comun'].widget.attrs['class'] = self.fields['nombre_comun'].widget.attrs.get('class', '') + ' bg-orange-100'
        self.fields['habitat'].widget.attrs['class'] = self.fields['habitat'].widget.attrs.get('class', '') + ' bg-orange-100'
        if 'descripcion' in self.fields:
            self.fields['descripcion'].widget.attrs['class'] = self.fields['descripcion'].widget.attrs.get('class', '') + ' h-32 resize-y'
...
class SauriosUpdateForm(SauriosForm):
    pass 